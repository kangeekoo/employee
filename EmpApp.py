...
def GetEmp():
    ...
    emp_name = "" + first_name + " " + last_name
    return render_template('outputGet.html', emp_id= emp_id, name=emp_name, email=email, contact=contact, location=location, position=position, pri_skill=pri_skill, hire_date=hire_date, payscale=payscale, emp_image_file=emp_image_file)
